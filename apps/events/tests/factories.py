...
from apps.events.enums import Category, EventType, LocationType, TimingType
...
class LocationFactory(factory.django.DjangoModelFactory):
    ...
    event = factory.SubFactory(EventFactory)
    location_type = factory.fuzzy.FuzzyChoice(
        choice[0] for choice in LocationType.choices
    )
